...
export const AllPokes = () => {
    ...
    return(
        <> 
        <div class="text-8xl tracking-wider font-bold tracking-tight text-black text-center pt-5 leading-relaxed bg-gradient-to-r from-indigo-500 via-purple-500 to-fuchsia-500">ALL POKES</div>
